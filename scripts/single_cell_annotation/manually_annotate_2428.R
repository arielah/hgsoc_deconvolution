...
sce <- readRDS(paste(local_data_path,"sce_objects/2428_clustered.rds",sep="/"))

plotUMAP(sce, colour_by="clusters")

ct <- fread(paste(local_data_path,"celltypist_output/2428_predicted_labels.csv", sep="/"))
...
saveRDS(sce, paste(local_data_path, "sce_objects/2428_labeled.rds", sep = "/"))